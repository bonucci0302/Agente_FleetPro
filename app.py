...
def pagina_chat():
    st.header('🤖Bem-vindo ao Oráculo FleetPró🛠️', divider=True)
    ...
    input_usuario = st.chat_input('Fale com o oráculo FleetPró')
    if input_usuario:
...
def sidebar():
    ...
    if st.button('Inicializar Oráculo FleetPró', use_container_width=True):
